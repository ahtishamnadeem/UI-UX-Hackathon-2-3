  ...
  return (
    ...
    <section className="flex flex-col lg:flex-row gap-8 p-5 lg:p-10">
      ...
      <section className="grid grid-cols-1 sm:grid-cols-2 gap-5 flex-1">
        <Image
          ...
          src="/why-1.png" // Replace with your image path
          alt="Dish 1"
        />
        <Image
          width={300}
          ...
          src="/blog-main.png" // Replace with your image path
          alt="Dish 2"
        />
        <Image
          width={300}
          ...
          src="/sd-main.png" // Replace with your image path
          alt="Dish 3"
        />
      </section>
    ...
    <section className="my-20 flex flex-col items-center px-5">
      ...
      <div className="w-full mx-auto">
        <Image
          src="/feedback-bg.png" // Replace with your image path
          alt="Dishes"
          width={1920}
          height={1080}
      ...
      <ul className="flex flex-col sm:flex-row flex-wrap justify-center gap-8 lg:gap-12 w-full">
        ...
        <li className="text-center flex flex-col items-center w-full sm:w-1/2 lg:w-1/4 px-4">
          <Image
            src="/cf6.png" // Replace with your image path
            alt="Best Chefs"
            width={100}
            height={100}
        ...
        <li className="text-center flex flex-col items-center w-full sm:w-1/2 lg:w-1/4 px-4">
          <Image
            src="/bft.png" // Replace with your image path
            alt="120 item food"
            width={100}
            height={100}
            className="w-24 h-24 object-cover rounded-full"
